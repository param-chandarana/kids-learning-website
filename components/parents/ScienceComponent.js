...
const stats = [
  { icon: "/parent/topics.png", label: "Topics Covered", value: 1 },
  { icon: "/parent/quizzes.png", label: "Quizzes Attempted", value: 1 },
  { icon: "/parent/questions.png", label: "Questions Correct", value: 6 },
];
