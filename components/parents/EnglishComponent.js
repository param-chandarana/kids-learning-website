...
const stats = [
  { icon: "/parent/topics.png", label: "Topics Covered", value: 3 },
  { icon: "/parent/quizzes.png", label: "Quizzes Attempted", value: 3 },
  { icon: "/parent/questions.png", label: "Questions Correct", value: 14 },
];
...
const EnglishComponent = () => {
  return (
    <>
      <div>
        <CircularProgressComponent value={72} />
      </div>
      <div>
